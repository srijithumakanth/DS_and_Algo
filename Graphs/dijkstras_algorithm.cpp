...
#include <limits.h>
#include <iostream>
#define V 9 // Number of vertices of a graph
...
void dijkstra(int graph[V][V], int src)
{
    ...
    for (int count = 0; count < V - 1; count++)
    {
       ...
       vertex from the set of vertices not yet processed. u is always equal to src in first iteration. */
